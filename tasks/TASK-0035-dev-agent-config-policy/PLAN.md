...
approved_dev_profile_reason: "設定parserとCLIに限定した局所変更で、外部通信、Credential、IPC、永続状態、OS変更、外部依存を含まず、約910行の手書き実装・testをhermeticに機械検証できるため"
...
planning_reviewed_at: "2026-08-01T10:00:25+10:00"
