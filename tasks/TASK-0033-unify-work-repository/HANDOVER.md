...
- `candidate_commit`: `b892dd5883f28cb9a7e7ac82ca132202c26d00fb`
- `candidate_tree`: `6ce6716159f853cd9d510be5675910f016688215`
- `managed_path_digest`: `39f46ea2e905dd6989ffb6cc3e36bbf134113835ea421f2a068070b8bfc0d88d`。DEV初回working-tree manifestは33ファイル、SHA-256 `77dcb2599590fb8ab78a101de7addc403811e797844cdc1ceec8ac8b6c9fcdaa`。
...
- Main判断の旧新コミット/tree、全差分とダイジェスト、影響ケース集合、レビュアー/`make check`証拠、理由: candidate `b892dd5883f28cb9a7e7ac82ca132202c26d00fb` / tree `6ce6716159f853cd9d510be5675910f016688215` / managed digest `39f46ea2e905dd6989ffb6cc3e36bbf134113835ea421f2a068070b8bfc0d88d`、bootstrap `a063f6d461bbc6ce752d93306f83e4939e299d1e` / digest `279dc69dba63337208ac4d0dd065db8055e7bb0b00fb8df5e0f9024d9f283329`。全QAケースが対象で、独立REVIEW/QAを新しい同一composite candidateから再実行する。
