...
- Mainによるbootstrap、freeze、candidate固定は完了した。GitHub実環境確認、merge、archiveは未実施である。

## candidate-bound DEV証跡

- `candidate_commit`: `bcc46d67408164945112000156c384f8977f4307`
- `candidate_tree`: `d62531f2aaeeb05360c7b7aeab6c528f67d01757`
- `managed_path_digest`: `8b96db42ceba409999a34bd068dea69504d78f9e8c213a181678cf50ef0d52b6`。DEV初回working-tree manifestは33ファイル、SHA-256 `77dcb2599590fb8ab78a101de7addc403811e797844cdc1ceec8ac8b6c9fcdaa`。
...
- `node --test scripts/task/unified-lifecycle.test.mjs`: 15/15 PASS。
- `pnpm test:process`: 94/94 PASS。既存のactive owner拒否、stale owner回復、rollback後lock解放検査もcommon-dir配置でPASS。
...
- Main判断の旧新コミット/tree、全差分とダイジェスト、影響ケース集合、レビュアー/`make check`証拠、理由: candidate `bcc46d67408164945112000156c384f8977f4307` / tree `d62531f2aaeeb05360c7b7aeab6c528f67d01757` / managed digest `8b96db42ceba409999a34bd068dea69504d78f9e8c213a181678cf50ef0d52b6`、bootstrap `a063f6d461bbc6ce752d93306f83e4939e299d1e` / digest `279dc69dba63337208ac4d0dd065db8055e7bb0b00fb8df5e0f9024d9f283329`。全QAケースが対象で、独立REVIEW/QAを同一composite candidateから開始する。
