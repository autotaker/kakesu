...
| QA-011 | 隔離copyでorder/disabled-stopped/containment/writer guardを各1箇所弱体化し対応test実行 | `/tmp/task0036-mutations.dZfx0k/{order,disabled,containment,writer}`、candidate sourceは不変 | 専用`GOCACHE` | 全4件 1（期待FAIL） | `/tmp/task0036-mutation-{order,disabled,containment,writer}.log`。SHA-256 `fe9bd20d814d92fbbc853a0d6d42c6b97a00fd31cbe80366c5b7f75855a00feb`、`fbf190b89e08ddd62989a0ba28c88ffd42432cba267c37ce11adf92bced55ad4`、`48d10b37425ec73acc33f176bf72a73803b97c215764a9260aee3d12c4ac511f`、`294aa8dfa1243518744e6febb541783026361a0b27b77daa1364c223d50a3441` | なし |
